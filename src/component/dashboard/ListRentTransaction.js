...
function Row(props) {
    ...
    return (
        <>
            <StyledTableRow key={row.c}>
                <StyledTableCell component="th" scope="row">{row.rentId}</StyledTableCell>
                ...
                <StyledTableCell align="center">
                    ...
                    <Link style={{ textDecoration: "none" }} to={{ pathname: `/dashboard/view-detailtransaction/${row.rentId}`, state: { data: row }, type: "rentlist" }}>
...
export default ListRentTransaction
